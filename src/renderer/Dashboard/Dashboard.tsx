...
import { FileIcon } from '../components/ExplorerFiles/FileIcon';
...
const exitProjectConfirmMessage = {
    title: 'You are exiting the project.',
    message: 'Are you sure you want to exit this project?',
};
...
export const Dashboard = () => {
    ...
    const [requestFormat, setFormat] = useState<boolean>(false);
    ...
    const onConfirmExitProject = () => {
        closeDirectory();
    };

    const handleCloseDirectory = () => {
        confirmAlert({
            ...exitProjectConfirmMessage,
            buttons: [
                {
                    label: 'Yes, exit project.',
                    onClick: () => onConfirmExitProject(),
                },
                {
                    label: 'No, keep project open.',
                    onClick: () => {},
                },
            ],
        });
        ...
        <Layout>
                        ...
                        {frameFile ? (
                            <div
                                style={{
                                    ...
                                    border: '1px solid rgb(79, 100, 121)',
                                    height: 32,
                                    display: 'inline-flex',
                                    alignSelf: 'flex-end',
                                    transform: 'translateY(3.5px)',
                                    background: 'rgba(79, 100, 121, 0.7)',
                                    padding: '7px 12px 0',
                                    borderRadius: '4px 4px 0 0',
                                    fontSize: 15,
                                }}
                            >
                                <FileIcon file={frameFile} />
                                <span
                                    style={{
            ...
            <Layout.ViewBar>
                ...
                <ViewButtonGroup>
                    <ViewButton
                        title="Format file"
                        onClick={handleRequestFormat}
                        disabled={currentView !== 'CODE' || !unsavedFrameFile}
                        roundedBottom
                        roundedTop
                    >
                        <FormatIndentIncreaseIcon size={ViewButtonIconSize} />
                    </ViewButton>
                </ViewButtonGroup>
            ...
            <Layout.Frame>
                ...
                unsavedFrameFile.name ? (
                    <CodeEditor
                        ...
                        onValid={handleValid}
                        onFileSave={(file) => handleSaveFile(file)}
