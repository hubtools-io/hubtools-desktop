...
export const moveFieldUp = (inputArr: any, field: any) => {
            ...
            if (!matchFound && item3.children && item3.type === 'group') {
              item3.children.forEach((item4: any, i4: any) => {
                if (
                  ...
                  matchFound = true;
                  const pos3 = newCopyArr[i].children[i2].children[i3].children;
                  pos3.splice(i4 - 1, 0, pos3.splice(i4, 1)[0]);
                  return;
                }
                ...
                if (!matchFound && item4.children && item4.type === 'group') {
                  item4.children.forEach((item5: any, i5: any) => {
                    if (
                      ...
                      matchFound = true;
                      const pos4 =
                        newCopyArr[i].children[i2].children[i3].children[i4]
                          .children;
                      pos4.splice(i5 - 1, 0, pos4.splice(i5, 1)[0]);
                    }
                  });
                }
              });
